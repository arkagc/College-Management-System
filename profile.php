 ...
 // Hiding Default Context Menu
    document.addEventListener('contextmenu', event => event.preventDefault());
        ...
        function validate(){
           ...
           var blankPostProfile=document.getElementById("pst").value;
            if(blankPostProfile==""){
                alert("Please Write Something. Let everyone know about your post");
                return false;
            }
            //Select Dept. while posting validation
            var filterProfile=document.getElementById("dptfltr").value;
            if(filterProfile==0){
    ...
    <!-- Top Navigation Bar -->
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><li><input type="search" name="search" id="user" onkeyup="suggest_items(this.value)" placeholder="Search..." title="Type Keyword" style="color:white;">
                <p id="suggestions"></p></li>
            </ul>
...
<!--------------------------------- User Information Column ------------------------------------------>
            <div class="col-sm-3" style="padding-right:1px;">
                ...
                <center>
                <span style="font-family:Andika; font-size:23px; text-shadow: 2px 2px 5px #a0bede;">
                    <?php 
                    ...
                    <div class="row">
                        ...
                        <span style="font-family:Andika; font-size:18px; cursor: pointer; text-align: center">
                        
                        <?php  echo $row['designation'];
                            }
                        ?>    
                        <a href="edit_profile.php"><i style="font-size: 16px; color: #4d2600" title="Edit Profile" class="fa fa-pencil"></i></a></span></center>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-sm-1">
                           ...
                           <i class="fa fa-phone" style="font-size: 15px; color: #734d26"></i>
                        </div>
                        <div class="col-sm-10">
                        <p style="font-family:Andika; font-size:15px; cursor: pointer; text-align: left">
                            0
                    ...
                    <button class="accordion">My Photos</button>
                        <div class="panel" style="padding-left: 6px; margin-bottom: 5px;">
                            
                             <?php 
                    foreach($row_mypost as $myphoto){ 
                            if($myphoto['attachment_photo']!=""){ 
                                    $imgstr=substr($myphoto['attachment_photo'],1);
                                    $tempimage=explode(";",$imgstr);
                                    for($i=0;$i<count($tempimage);$i++){ 
                                ?>
                                  <a target="_blank" href="postimage/<?php echo $tempimage[$i]; ?>">
                                    
                                <img src="postimage/<?php echo $tempimage[$i]; ?>" style="width:80px" id="img">
                            </a>
                            <?php }
                            }
                    }
                    ...
                    <button class="accordion">My Videos</button>
                        <div class="panel" style="margin-bottom: 5px;">
                              <?php 
                                foreach($row_mypost as $myvideo){ 
                                    if($myvideo['attachment_video']!=""){ ?>
                            <video width="120" height="80"controls>
                               <source src="postvideo/<?php echo $myvideo['attachment_video'] ?>" type="video/mp4">
                            </video>
                            <?php } 
                    ...
                    <button class="accordion">My Files</button>
                        <div class="panel">
                            <p style="color: red; text-align: center">Coming Soon !!!<br></p>
                    </div>
                    <script>
        ...
        <div class="col-sm-7" style="padding-right:2px;">
                    ...
                    <div class="row" style="padding-left:28px; padding-right:13px;">
                        <form name="frm" action="profile_process.php" method="post" enctype="multipart/form-data" onsubmit="return validate()">
                            ...
                            <textarea class="form-control" rows="3" id="pst" name="text_post" placeholder="Write Something..." style="resize: none"></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2" style="text-align: left; padding-left: 0px;">
                                    <div class="form-group">
                                <select class="form-control" id="dptfltr" name="deptfilter" style="width: 145px; height: 38px">
                ...
                <div class="well" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.1); margin-right:13px; padding-left:1px;">
                    ...
                    <div class="row">
                        ...
                        <?php } ?>
                            ...
                            <?php 
                            echo '<a href="profile_member.php?username='.$post_detail['user_id'].'"'. 'style="font-family:Andika; font-size:18px; text-decoration: none;">'.$post_detail["first_name"].' '.$post_detail["middle_name"].' '.$post_detail["last_name"].'</a>';
                            ?>
                        </div>
                        ...
                        <ul style="list-style-type:none;">  
                           ...
                           <ul class="dropdown-menu">
                               ...
                               <li><a href="delete_post.php?post_id=<?php echo $post_id?>"><i class="fa fa-cut"></i>&nbsp;&nbsp;Delete Post</a></li>
                           </ul>
                        </li></ul>
                        </div>
                    </div>
