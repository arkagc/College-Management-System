...
<html lang="en-US">
    ...
    <body id="background" onload="init()">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="myTopnav"
            ...
            <h1 class="well" style="text-align:center; margin-top:50px; background-color:rgba(133,133,173,0.8); box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0,0,0,0.5);">Registration Form</h1>
