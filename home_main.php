...
<head>
    ...
    <title>Home | College Campus</title>
    <meta charset="utf-8">
            ...
            <div class="col-sm-3" style="padding-right:1px;">
                ...
                <center><p style="font-family:Andika; font-size:23px; text-shadow: 2px 2px 5px #a0bede; cursor: pointer;">
                    ...
                    <div class="row" style="margin-bottom: 8px; text-align:left">
                        ...
                        <a href="https://mail.google.com/mail/u/0/?tab=wm#inbox" target="_blank" style="font-family:Andika; font-size:15px; text-decoration: none; text-align: left" data-toggle="tooltip" data-placement="top" title="Open Email">
                    ...
                    <div class="row">
                        ...
                        <?php if ($row['district']!="" && $row['state']!=""){ ?>
                            <i class="fa fa-home" style="font-size: 15px; color: #734d26"></i> 
            ...
            <div class="col-sm-7" style="padding-right:2px;">
                <div class="well" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.1); margin-right:13px; padding-left:1px;">
                    ...
                    <div class="row" style="padding-left:28px; padding-right:13px;">
                        <form name="frm" action="home_process.php" method="post" enctype="multipart/form-data" onsubmit="return validate()">
                            <div class="form-group">
                            <textarea class="form-control" rows="3" id="post" name="text_post" placeholder="Write Something..."></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2" style="text-align: left; padding-left: 0px;">
                                    <div class="form-group">
                                <select class="form-control" id="deptfilter" name="deptfilter" style="width: 145px; height: 38px">
...
<!-- Well for Showing Post-->
                ...
                <div class="well" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.1); margin-right:13px; padding-left:1px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="margin-left: 6px;">
                          <?php if($post_det['profile_picture']==""){ ?>
                        ...
                        <?php } 
                         ...
                         <a target="_blank" href="profilephoto/<?php echo $post_det['profile_picture'];?>" data-toggle="tooltip" data-placement="bottom" title="Click to Expand"> 
                        <img src="profilephoto/<?php echo $post_det['profile_picture'];?>" alt="Profile Picture" style="border-radius: 50%; height:30px; width:30px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.1);"></a>
                        <?php } ?>
                            <?php 
                            echo '<a href="profile_member.php?username='.$post_det['user_id'].'"'.'style="font-family:Andika; font-size:18px; text-decoration: none;">'.$post_det["first_name"].' '.$post_det["middle_name"].' '.$post_det["last_name"].'</a>';
                            ?>
                        </div>
                       
                        <!--Divider for showing Post Date & Time-->
                        <div class="col-sm-4">
                        <p style="font-family:Andika; font-size:15px; float: right;"><?php echo $post_det['post_date_time'] ?></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-11">
                            <p style="font-family:Andika; font-size:14px; float: left; ">&#9679;&nbsp;<?php echo $post_det['designation'];?></p>&nbsp<span style="color: #cc2900; font-family:Andika; font-size:14px;"><?php echo "(Post for"." ".$post_det['post_dept'].")"?></span>
                        </div> 
                    </div>
                    <br>
                    <!-- Post Body -->
                    <div class="row" style="padding-left: 20px;">
                        <div class="col-sm-12">
                            ...
                            <?php if($post_det['post_desc']!=""){ ?>
                            <p><?php echo $post_det['post_desc']; ?></p>
                            <?php } ?>
                            
                            
                                <?php if($post_det['attachment_photo']!=""){ 
                                $imgstr=substr($post_det['attachment_photo'],1);
                            ...
                            <?php if($post_det['attachment_video']!=""){ ?>
                            <video width="480" height="360"controls>
                               <source src="postvideo//<?php echo $post_det['attachment_video'] ?>" type="video/mp4">
                            </video>
                           <?php } ?> 
                            
                            <?php 
                            if($post_det['attachment_file']!=""){?>
                            <a target="_blank" style="font-size: 15px; color: #2d5986; border: 1px solid; padding: 10px; box-shadow: 2px 4px #888888; border-radius: 10px; text-decoration: none" href="postdocs/<?php echo $post_det['attachment_file']; ?>"><?php echo $post_det["first_name"].' '.$post_det["middle_name"].' '.$post_det["last_name"]?>&nbsp;uploaded a new file</a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3" style="margin-left: 25px;">
                        <?php //echo $post_id; ?>
                        <i class="fa fa-comments-o" id="comment" data-target="#modalComment" data-toggle="modal"></i>
                        
                            <?php
                            $count=$db->countComment($post_id);
                            if($count['count_comment']!="0"){ ?>
                        <span class="badge" style="background-color: #000000">
                             <?php echo $count['count_comment'];   
                            }
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <!-- COMMENT FORM FOR SUMBITTING VALUE -->
                                <?php echo $post_id; ?>
                                <form name="comment_form" method="post" action="inser_comment.php?post_id=<?php echo $post_id?>&user_id=<?php echo $user_id ?>">
                                <textarea class="form-control" rows="3" name="comm" id="comm" placeholder="Write Your Comment Here..." value=""></textarea>
                                <input type="submit" class="btn_confirm" value="Comment" name="comment"></div>
                                </form>
                        </div>
                    </div>
                </div> 
                ...
                <!-- Comment Text -->
                    ...
                    foreach($cmnt as $cmnt_det){
                        $comment_user_id=$cmnt_det['comment_user_id'];
                        //echo $comment_user_id;
                        //echo $post_id;
                        //die;
                        $image=$db->getImage($comment_user_id);
                ...
                <div class="row">
                 ...
                 <a href="#" style="text-decoration:none;" data-toggle="tooltip" data-placement="top" title="Click to View">
                        <img src="profilephoto/<?php echo $image['profile_picture'] ?>" class="img-rounded" style="height: 30px; width: 30px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.1); border-radius: 50%; margin-left: 8px;">&nbsp;
                        <span style="font-family:Andika; font-size:16px;">
                            <?php echo $cmnt_det['first_name'].' '.$cmnt_det['middle_name'].' '.$cmnt_det['last_name']?></span>
                        </a>
                    </div>
                    <div class="col-sm-3" style="margin-top: 10px">
                        <span class="glyphicon glyphicon-time">
                            <span style="font-family:Andika; font-size:12px; padding-left: 0px">
                            <?php echo $cmnt_det['cmnt_date_time'] ?>
                            </span></span>
                    </div>
                </div> 
                <div class="row">
